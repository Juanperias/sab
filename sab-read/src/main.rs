...
fn main() {
    ...
    obj.create_section(0, "text".as_bytes(), vec![2,2,2], SectionKind::Code, SectionFlags::RXA);
    ...
    let file = obj.to_file(sab::core::header::Endian::Little, sab::core::header::Machine::Jmc32);
